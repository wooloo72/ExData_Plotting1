...
# second plot
with(Subset_data, plot(Voltage~TS, xlab= "datetime", ylab = "Voltage", type="l"))
...
# fourth plot
with(Subset_data, plot(Global_reactive_power~TS, xlab= "datetime", ylab = "Global _reactive_power", type="l"))
